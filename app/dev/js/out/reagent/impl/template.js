...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__27431__auto__,writer__27432__auto__,opt__27433__auto__){
return cljs.core._write.call(null,writer__27432__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__28378 = o;
(G__28378[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.truth_((function (){var and__26767__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__26767__auto__){
var and__26767__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__28387 = jsprops;
(G__28387["defaultValue"] = value);

(G__28387["onChange"] = ((function (G__28387,v,value,on_change){
return (function (p1__28384_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__28384_SHARP_);
});})(G__28387,v,value,on_change))
);

(G__28387["ref"] = ((function (G__28387,v,value,on_change){
return (function (p1__28385_SHARP_){
return (this$["cljsInputElement"] = p1__28385_SHARP_);
});})(G__28387,v,value,on_change))
);
...
var vec__28394 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__28394,(0),null);
var id = cljs.core.nth.call(null,vec__28394,(1),null);
var class$ = cljs.core.nth.call(null,vec__28394,(2),null);
...
var jsprops = ({"argv": v});
var temp__6507__auto___28399 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__6507__auto___28399 == null)){
} else {
var key_28400 = temp__6507__auto___28399;
(jsprops["key"] = key_28400);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__28402 = (new reagent.impl.template.NativeWrapper());
(G__28402["name"] = c);
...
var len__27958__auto___28407 = arguments.length;
var i__27959__auto___28408 = (0);
while(true){
if((i__27959__auto___28408 < len__27958__auto___28407)){
args__27965__auto__.push((arguments[i__27959__auto___28408]));

var G__28409 = (i__27959__auto___28408 + (1));
i__27959__auto___28408 = G__28409;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__27966__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq28405){
var G__28406 = cljs.core.first.call(null,seq28405);
var seq28405__$1 = cljs.core.next.call(null,seq28405);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__28406,seq28405__$1);
});
...
break;
default:
var G__28413 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__28413;
continue;
...
var n__27792__auto___28416 = a.length;
var i_28417 = (0);
while(true){
if((i_28417 < n__27792__auto___28416)){
(a[i_28417] = reagent.impl.template.as_element.call(null,(a[i_28417])));
...
var a = cljs.core.into_array.call(null,s);
var n__27792__auto___28419 = a.length;
var i_28420 = (0);
while(true){
if((i_28420 < n__27792__auto___28419)){
var val_28421 = (a[i_28420]);
if((cljs.core.vector_QMARK_.call(null,val_28421)) && ((reagent.impl.template.key_from_vec.call(null,val_28421) == null))){
(o["no-key"] = true);
} else {
}

(a[i_28420] = reagent.impl.template.as_element.call(null,val_28421));
...
var ctx = ({});
var vec__28426 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__28426,(0),null);
var derefed = cljs.core.nth.call(null,vec__28426,(1),null);
...
var G__28430 = (cljs.core.count.call(null,argv) - first_child);
switch (G__28430) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__28430){
