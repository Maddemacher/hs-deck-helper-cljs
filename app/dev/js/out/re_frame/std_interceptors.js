...
var vec__28700_28703 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_28704 = cljs.core.nth.call(null,vec__28700_28703,(0),null);
var only_after_28705 = cljs.core.nth.call(null,vec__28700_28703,(1),null);
var db_changed_QMARK__28706 = (cljs.core.some_QMARK_.call(null,only_before_28704)) || (cljs.core.some_QMARK_.call(null,only_after_28705));
if(db_changed_QMARK__28706){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for: ",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before: ",only_before_28704);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after : ",only_after_28705);
...
var map__28713 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__28713__$1 = ((((!((map__28713 == null)))?((((map__28713.cljs$lang$protocol_mask$partition0$ & (64))) || (map__28713.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__28713):map__28713);
var db = cljs.core.get.call(null,map__28713__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__28713__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__28721 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__28721__$1;
var event = cljs.core.get.call(null,map__28721__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__27958__auto___28724 = arguments.length;
var i__27959__auto___28725 = (0);
while(true){
if((i__27959__auto___28725 < len__27958__auto___28724)){
args__27965__auto__.push((arguments[i__27959__auto___28725]));

var G__28726 = (i__27959__auto___28725 + (1));
i__27959__auto___28725 = G__28726;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__27966__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq28723){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq28723));
});
...
var args__27965__auto__ = [];
var len__27958__auto___28732 = arguments.length;
var i__27959__auto___28733 = (0);
while(true){
if((i__27959__auto___28733 < len__27958__auto___28732)){
args__27965__auto__.push((arguments[i__27959__auto___28733]));

var G__28734 = (i__27959__auto___28733 + (1));
i__27959__auto___28733 = G__28734;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__27966__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__28727_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__28728_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__28728_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq28729){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__28730,G__28731,seq28729__$2);
});
